...
/// Accept Claude Code plugin manifests as-is. claw-code mirrors Claude Code's
...
/// Materialize claw-code's structured command entries (`{name, description,
