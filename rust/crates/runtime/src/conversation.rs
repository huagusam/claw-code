    ...
    T: ToolExecutor,
{
    ...
    pub fn run_turn(
        ...
        loop {
            ...
            Arc::make_mut(&mut api_messages).push(assistant_message.clone());
            ...
            for (tool_use_id, tool_name, input) in pending_tool_uses {
                ...
                let pre_hook_result = self.run_pre_tool_use_hook(&tool_name, &input_str);
                let effective_input: String = pre_hook_result
                    .updated_input()
                    .map_or_else(|| input_str, ToOwned::to_owned);
                ...
                self.session
                    ...
                    .map_err(|error| RuntimeError::new(error.to_string()))?;
                Arc::make_mut(&mut api_messages).push(result_message.clone());
...
mod tests {
    ...
    fn auto_compacts_when_cumulative_input_threshold_is_crossed() {
        ...
        assert!(
            ...
            "savings_ratio should be positive"
        );
